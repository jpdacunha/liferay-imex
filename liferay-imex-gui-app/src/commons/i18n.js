...
const resources = {
  en: {
    translation: {
      ...
      'at-least-one-importer-alert-message': 'No selected importer. At least one importer need to be selected.',
  ...
  fr: {
    translation: {
      ...
      'at-least-one-importer-alert-message': 'Vous devez selectionner au moins un importer avant de lancer cette action',
