...
public class ImporterDescriptor implements Serializable {
	...
	public static ImporterDescriptor unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ImporterDescriptor.class, json);
	}

	@Schema(description = "Importer description")
	...
	@GraphQLField(description = "Importer description")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String description;

	@Schema(description = "Unique importer name")
	...
	@GraphQLField(description = "Unique importer name")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String name;

	@Schema(description = "Importer execution priority")
	...
	@GraphQLField(description = "Importer execution priority")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(description = "Importer OSGI ranking")
	...
	@GraphQLField(description = "Importer OSGI ranking")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String ranking;

	@Schema(description = "Profiles supported by importer")
	...
	@GraphQLField(description = "Profiles supported by importer")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
