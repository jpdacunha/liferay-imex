...
public abstract class BaseExportersResourceImpl implements ExportersResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/imex-rest-trigger/v1.0/exporters'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Gets the list of registered exporters"
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Exporters")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/exporters")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseExportersResourceImpl.class);
