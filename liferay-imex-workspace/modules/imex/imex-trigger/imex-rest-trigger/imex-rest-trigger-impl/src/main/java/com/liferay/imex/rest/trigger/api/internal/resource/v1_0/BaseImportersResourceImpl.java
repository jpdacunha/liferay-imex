...
public abstract class BaseImportersResourceImpl implements ImportersResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/imex-rest-trigger/v1.0/importers'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Gets the list of registered exporters"
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Importers")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/importers")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseImportersResourceImpl.class);
