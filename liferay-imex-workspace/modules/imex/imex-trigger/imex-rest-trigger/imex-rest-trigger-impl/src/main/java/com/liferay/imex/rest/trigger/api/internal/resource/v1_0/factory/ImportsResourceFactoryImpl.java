...
public class ImportsResourceFactoryImpl implements ImportsResource.Factory {
	...
	public ImportsResource.Builder create() {
		return new ImportsResource.Builder() {
			...
			public ImportsResource build() {
				...
				return _importsResourceProxyProviderFunction.apply(
			...
			@Override
			public ImportsResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, ImportsResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ImportsResource.class.getClassLoader(), ImportsResource.class);

		try {
			Constructor<ImportsResource> constructor =
				(Constructor<ImportsResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		importsResource.setContextHttpServletResponse(httpServletResponse);
		importsResource.setContextUser(user);
		importsResource.setExpressionConvert(_expressionConvert);
		importsResource.setFilterParserProvider(_filterParserProvider);
		importsResource.setGroupLocalService(_groupLocalService);
		importsResource.setResourceActionLocalService(
			_resourceActionLocalService);
		importsResource.setResourcePermissionLocalService(
			_resourcePermissionLocalService);
		importsResource.setRoleLocalService(_roleLocalService);
	...
	private static final Function<InvocationHandler, ImportsResource>
		_importsResourceProxyProviderFunction = _getProxyProviderFunction();
