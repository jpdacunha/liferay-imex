...
public class ReportsResourceFactoryImpl implements ReportsResource.Factory {
	...
	public ReportsResource.Builder create() {
		return new ReportsResource.Builder() {
			...
			public ReportsResource build() {
				...
				return _reportsResourceProxyProviderFunction.apply(
			...
			@Override
			public ReportsResource.Builder httpServletResponse(
	...
	private static Function<InvocationHandler, ReportsResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ReportsResource.class.getClassLoader(), ReportsResource.class);

		try {
			Constructor<ReportsResource> constructor =
				(Constructor<ReportsResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		reportsResource.setContextHttpServletResponse(httpServletResponse);
		reportsResource.setContextUser(user);
		reportsResource.setExpressionConvert(_expressionConvert);
		reportsResource.setFilterParserProvider(_filterParserProvider);
		reportsResource.setGroupLocalService(_groupLocalService);
		reportsResource.setResourceActionLocalService(
			_resourceActionLocalService);
		reportsResource.setResourcePermissionLocalService(
			_resourcePermissionLocalService);
		reportsResource.setRoleLocalService(_roleLocalService);
	...
	private static final Function<InvocationHandler, ReportsResource>
		_reportsResourceProxyProviderFunction = _getProxyProviderFunction();
