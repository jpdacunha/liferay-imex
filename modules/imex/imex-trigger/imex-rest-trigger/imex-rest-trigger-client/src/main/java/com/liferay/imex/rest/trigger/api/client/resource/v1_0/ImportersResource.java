...
public interface ImportersResource {
	...
	public HttpInvoker.HttpResponse getImportersPageHttpResponse()
		throws Exception;
	...
	public static class Builder {
		...
		public ImportersResource build() {
			return new ImportersResourceImpl(this);
		}
	...
	public static class ImportersResourceImpl implements ImportersResource {

		public Page<ImporterDescriptor> getImportersPage() throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getImportersPageHttpResponse();
			...
			try {
				return Page.of(content, ImporterDescriptorSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getImportersPageHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/imex-rest-trigger/v1.0/importers");
		...
		private ImportersResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ImportersResource.class.getName());
