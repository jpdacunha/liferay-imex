...
(function($) {
	...
	*/
	(function() {
		...
		if (document.getElementById("flotBasic")) {
	...
	*/
	(function() {
		...
		if (document.getElementById("flotRealTime")) {
	...
	*/
	(function() {
		...
		if (document.getElementById("flotBars")) {
	...
	*/
	(function() {
	if (document.getElementById("flotPie")) {
	...
	*/
	...
	Morris: Donut
	*/
	if (document.getElementById("morrisDonut")) {
	...
	Morris: Bar
	*/
	if (document.getElementById("morrisBar")) {
	...
	*/
	...
	Morris: Stacked
	*/
	if (document.getElementById("morrisStacked")) {
	...
	*/
	(function() {
		if (document.getElementById("gaugeBasic")) {
	...
	*/
	...
	Liquid Meter Dark
	*/
	if (document.getElementById("meterDark")) {
	...
	Sparkline: Line
	*/
	if (document.getElementById("sparklineLine")) {	
	...
	Sparkline: Bar
	*/
	if (document.getElementById("sparklineBar")) {	
	...
	Sparkline: Tristate
	*/
	if (document.getElementById("sparklineTristate")) {	
	...
	Sparkline: Discrete
	*/
	if (document.getElementById("sparklineDiscrete")) {	
	...
	Sparkline: Bullet
	*/
	if (document.getElementById("sparklineBullet")) {	
	...
	Sparkline: Pie
	*/
	if (document.getElementById("sparklinePie")) {	
	...
	*/	
	(function() {
	if (document.getElementById("ChartistSimpleLineChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistLineScatterDiagramWithResponsiveSettings")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistLineChartWithTooltips")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistLineChartWithArea")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistBiPolarLineChartWithAreaOnly")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistEventsToReplaceGraphics")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistLineInterpolationSmoothing")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistBiPolarBarChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistOverlappingBarsOnMobile")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistAddPeakCirclesUsingDrawEvents")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistMultiLineLabels")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistStackedChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistHorizontalChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistExtremeResponsiveConfiguration")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistSimplePieChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistPieChartWithCustomLabels")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistGaugeChart")) {	
	...
	*/
	(function() {
		if (document.getElementById("ChartistCSSAnimation")) {	
