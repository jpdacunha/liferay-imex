...
(function($) {
	...
	*/
	...
	Flot: Sales 1
	*/
	if (document.getElementById("flotDashSales1")) {
	...
	Flot: Sales 2
	*/
	if (document.getElementById("flotDashSales2")) {
	...
	Flot: Sales 3
	*/
	if (document.getElementById("flotDashSales3")) {	
	...
	*/
	...
	Flot: Basic
	*/
	if (document.getElementById("flotDashBasic")) {
	...
	*/
	(function() {
		if (document.getElementById("flotDashRealTime")) {
	...
	Sparkline: Bar
	*/
	if (typeof(sparklineBarDashData) != 'undefined') {
	...
	Sparkline: Line
	*/
	if (typeof(sparklineLineDashData) != 'undefined') {
	...
	*/
	...
	if (document.getElementById("vectorMapWorld")) {
