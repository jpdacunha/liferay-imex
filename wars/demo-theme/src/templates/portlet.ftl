<#assign
	...
	portlet_root_id = htmlUtil.escape(portlet_display.getRootPortletId())
/>

<#assign portlet_has_container = 	portlet_root_id == "com_liferay_nested_portlets_web_portlet_NestedPortletsPortlet"
								||	portlet_root_id == "com_liferay_wiki_web_portlet_WikiPortlet"		
								||	portlet_root_id == "com_liferay_blogs_web_portlet_BlogsPortlet"		
								||	portlet_root_id == "com_liferay_message_boards_web_portlet_MBPortlet" />

<#if portlet_has_container>
<div class="container">		
</#if>

<section class="portlet" id="portlet_${portlet_id}" alt="${portlet_root_id}">
